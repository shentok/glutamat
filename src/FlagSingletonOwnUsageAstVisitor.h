...
class FlagSingletonOwnUsageAstVisitor : public clang::RecursiveASTVisitor<FlagSingletonOwnUsageAstVisitor>
{
public:
    FlagSingletonOwnUsageAstVisitor(clang::DiagnosticsEngine &diagnosticsEngine, const clang::SourceManager &sourceManager);
